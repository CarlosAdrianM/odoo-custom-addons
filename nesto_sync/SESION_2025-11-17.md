...
|------|---------|-------------|
| `877de8f` | chore: Mejorar logs sanitizando datos binarios de imágenes | Sanitización de logs para campos image_* |
...
- `test_v2_5_0_features.py`: Test suite para v2.5.0
